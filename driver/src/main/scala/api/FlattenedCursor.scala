...
class FlattenedCursor[T](
  ...
  final override def headOption(
      implicit
      ec: ExecutionContext
    ): Future[Option[T]] = cursor.flatMap(_.headOption)
  ...
  final def foldBulks[A](
      ...
      ec: ExecutionContext
    ): Future[A] = cursor.flatMap(_.foldBulks(z, maxDocs)(suc, err))
  ...
  final def foldBulksM[A](
      ...
      ec: ExecutionContext
    ): Future[A] = cursor.flatMap(_.foldBulksM(z, maxDocs)(suc, err))
  ...
  final def foldWhile[A](
      ...
      ec: ExecutionContext
    ): Future[A] = cursor.flatMap(_.foldWhile(z, maxDocs)(suc, err))
  ...
  final def foldWhileM[A](
      ...
      ec: ExecutionContext
    ): Future[A] = cursor.flatMap(_.foldWhileM(z, maxDocs)(suc, err))
